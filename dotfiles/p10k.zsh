# Generated by Powerlevel10k configuration wizard on 2021-05-14 at 18:19 CDT.
...
() {
  ...
  #typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|fluxctl|stern|k'
